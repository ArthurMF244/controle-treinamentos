...
?>
<header class="page-header"><div><span class="eyebrow">Acompanhamento</span><h1>Participantes</h1><p>Inscreva pessoas e acompanhe a evolução em cada treinamento.</p></div></header>
...
<section class="panel">
    ...
    <?php else: ?><div class="table-wrapper"><table><thead><tr><th>Participante</th><th>Treinamento</th><th>Carga horária</th><th>Inscrito em</th><th>Status</th><th>Progresso</th><th>Ações</th></tr></thead><tbody><?php foreach ($enrollments as $enrollment): ?><tr>
