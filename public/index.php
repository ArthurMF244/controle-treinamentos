...
$upcoming = $pdo->query(<<<'SQL'
    SELECT t.titulo, t.data_inicio, t.data_fim, l.nome AS local_nome, st.nome AS status_nome,
...
<header class="page-header">
    <div>
        ...
        <h1>Dashboard</h1>
        <p>Acompanhe os treinamentos institucionais em um só lugar.</p>
    </div>
    <a class="btn primary" href="treinamentos.php?novo=1"><i class="fa-solid fa-plus"></i> Novo treinamento</a>
</header>
...
<section class="panel">
    ...
    <?php else: ?>
        <div class="table-wrapper"><table><thead><tr><th>Treinamento</th><th>Início</th><th>Local</th><th>Participantes</th><th>Status</th></tr></thead><tbody>
        <?php foreach ($upcoming as $training): ?>
            <tr><td><strong><?= e($training['titulo']) ?></strong><br><small>Até <?= e(formatDateTime($training['data_fim'])) ?></small></td><td><?= e(formatDateTime($training['data_inicio'])) ?></td><td><?= e($training['local_nome']) ?></td><td><?= (int) $training['participantes'] ?></td><td><span class="badge"><?= e($training['status_nome']) ?></span></td></tr>
        <?php endforeach; ?>
        </tbody></table></div>
    <?php endif; ?>
</section>
